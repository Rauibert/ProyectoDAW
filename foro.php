...
<html>
    <head>
        <meta charset="UTF-8">
        <title>DevSocial - La red social de los programadores - Foro</title>
    ...
    <body>
        ...
        <div id="foro">
            ...
            <form action="temasForo.php" name="formularioForo" id="formularioForo" method="POST">
                <h3>Título </h3><input type="text" name="tituloForo" id="tituloForo"/><br/>
                <h3>Mensaje </h3><textarea name="mensajeForo" id="mensajeForo" cols="100" rows="5"></textarea><br/>
                <input type="hidden" name="usuarioForo" value="<?php if(isset($_SESSION['administrador'])){echo $_SESSION['administrador'];}else if(isset($_SESSION['usuario'])){echo $_SESSION['usuario'];} ?>"</input>
                <input type="submit" name="sendForo" id="sendForo" value="Enviar"/><br/>                
            </form>
        </div>
